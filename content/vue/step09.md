...
{{> DiffBox step="9.2" tutorialName="simple-todos-vue"}}
...
{{> DiffBox step="9.3" tutorialName="simple-todos-vue"}}

{{> DiffBox step="9.4" tutorialName="simple-todos-vue"}}
